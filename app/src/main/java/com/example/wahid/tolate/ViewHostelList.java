...
public class ViewHostelList extends AppCompatActivity {

    DatabaseReference databaseReference;
    ArrayList<UploadRoomFlat> uploadRoomFlats;
    RecyclerView recyclerView;
    HostelAdepter hostelAdepter;
    FirebaseUser user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_hostel_list);

        user = FirebaseAuth.getInstance().getCurrentUser();
        recyclerView = findViewById(R.id.recyclerViewForHostel);
        uploadRoomFlats = new ArrayList<>();
        searchView = findViewById(R.id.hostelSearchId);

        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        databaseReference = FirebaseDatabase.getInstance().getReference("UploadData").child("Hostel");
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                hostelAdepter = new HostelAdepter(ViewHostelList.this,uploadRoomFlats);
                recyclerView.setAdapter(hostelAdepter);
            }
    ...
    private void search(String str) {
        ...
        HostelAdepter hostelAdepter = new HostelAdepter(myList);
        recyclerView.setAdapter(hostelAdepter);
    }
}
