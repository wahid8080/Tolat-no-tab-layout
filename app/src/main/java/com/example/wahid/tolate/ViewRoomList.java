...
public class ViewRoomList extends AppCompatActivity {

    DatabaseReference databaseReference;
    ArrayList<UploadRoomFlat> uploadRoomFlats;
    RecyclerView recyclerView;
    RoomAdepter roomAdepter;
    FirebaseUser user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_room_list);

        user = FirebaseAuth.getInstance().getCurrentUser();
        recyclerView = findViewById(R.id.roomViewId);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                roomAdepter = new RoomAdepter(ViewRoomList.this,uploadRoomFlats);
                recyclerView.setAdapter(roomAdepter);
            }
    ...
    private void search(String str) {
        ...
        RoomAdepter roomAdepter = new RoomAdepter(myList);
        recyclerView.setAdapter(roomAdepter);
    }
